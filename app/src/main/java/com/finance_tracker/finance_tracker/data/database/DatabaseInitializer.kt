...
class DatabaseInitializer(
    ...
    private val defaultCategories = listOf(
        Category(
            id = 0,
            name = "Restoraunt",
            icon = R.drawable.ic_category_1
        ),
        Category(
            id = 1,
            name = "Health",
            icon = R.drawable.ic_category_2
        ),
        Category(
            id = 2,
            name = "Child",
            icon = R.drawable.ic_category_3
        ),
        Category(
            id = 3,
            name = "Car",
            icon = R.drawable.ic_category_4
        ),
        Category(
            id = 4,
            name = "Education",
            icon = R.drawable.ic_category_5
        ),
        Category(
            id = 5,
            name = "Entertaiment",
            icon = R.drawable.ic_category_6
        ),
        Category(
            id = 6,
            name = "Sport",
            icon = R.drawable.ic_category_7
        ),
        Category(
            id = 7,
            name = "Public Transport",
            icon = R.drawable.ic_category_8
        ),
        Category(
            id = 8,
            name = "Shop",
        ...
        Category(
            id = 9,
            name = "Utilities",
            icon = R.drawable.ic_category_10
        ),
        Category(
            id = 10,
            name = "Clothes",
            icon = R.drawable.ic_category_11
        ),
        Category(
            id = 11,
            name = "Electonics",
            icon = R.drawable.ic_category_12
        ),
        Category(
            id = 12,
            name = "Correct",
