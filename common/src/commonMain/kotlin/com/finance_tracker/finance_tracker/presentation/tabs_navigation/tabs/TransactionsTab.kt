    ...
    override val configuration: TabConfiguration
        ...
        get() {
            ...
            return TabConfiguration(
                title = getLocalizedString("tab_transactions", context),
                selectedIcon = rememberVectorPainter(loadXmlPicture("ic_transactions_active")),
                unselectedIcon = rememberVectorPainter(loadXmlPicture("ic_transactions_inactive")),
