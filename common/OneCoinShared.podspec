Pod::Spec.new do |spec|
    ...
    if !Dir.exist?('build/cocoapods/framework/OneCoinShared.framework') || Dir.empty?('build/cocoapods/framework/OneCoinShared.framework')
        raise "

        Kotlin framework 'OneCoinShared' doesn't exist yet, so a proper Xcode project can't be generated.
